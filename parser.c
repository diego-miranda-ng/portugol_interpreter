// A maior parte das funções existente neste aruivo são referentes a cada regra sintática
// definida através da EBNF. Para cada regra da EBNF foi criada uma função que a represente,
/*-----------------------------------------------------------------------------------------*/
